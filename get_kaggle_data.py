...
Fetch any Kaggle competition, convert & anonymize CSVs → Parquet,
report basic stats, and either:
  • honor an existing train/test split, or
  • sample your own held-out test set.
"""
